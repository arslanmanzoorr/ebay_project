-- PostgreSQL initialization script for Bidsquire Production
-- This script runs automatically when PostgreSQL container starts for the first time
-- Creates all necessary tables and default admin user for production
...
DO $$
BEGIN
    RAISE NOTICE 'Bidsquire production database initialized successfully!';
